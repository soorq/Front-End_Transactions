import { BiStats, BiUpArrow, BiDownArrow } from 'react-icons/bi';
...
export type TypePropsSidebar = {
    open?: boolean | string | undefined;
};

const SideBar: React.FC<TypePropsSidebar> = ({ open }) => {
    ...
    return (
        <>
            <aside
                ...
                className={`w-64 h-full overflow-y-auto transition-transform transform sm:${
                    ...
                    <ul className="relative space-y-2 font-medium">
                        <li>
                            ...
                            >
                                ...
                                {openDrop ? <BiUpArrow /> : <BiDownArrow />}
                            </button>
                            <ul
                                className={`transition-transform transform ${
                                    openDrop
                                        ? '-translate-x-0 opacity-100 delay-150'
                                        : '-translate-x-[150%] opacity-0 absolute opacity delay-0'
                                } py-2 space-y-2 text-sm`}
                            >
                                <li
                                    className={`-translate-x-0 ${
                                        openDrop ? 'delay-200' : 'delay-0'
                                    }`}
                                >
                                    <Link
                                        to="/"
...
export const CtaNoti = () => {
    return (
        <Sidebar.CTA>
            ...
            <a
                className="text-sm underline text-cyan-900 hover:text-cyan-800 dark:text-gray-400 dark:hover:text-gray-300"
                href="#"
            >
